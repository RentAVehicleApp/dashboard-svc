...
import rent.vehicle.workerservicemodel.dto.ResponseWorkerDto;
...
public class TicketDashboardServiceImpl implements  TicketDashboardService {
    ...
    @Override
    public Mono<CustomPage<ResponseTicketDto>> searchTickets(Object simpleRequest) {
        GenericSearchRequest searchRequest = customerAdapterService
